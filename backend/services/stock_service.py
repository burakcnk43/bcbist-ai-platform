...
class StockService:
    ...
    def analyze_stock(self, symbol: str) -> dict[str, Any]:
        ...
        return {
            ...
            "fundamental": {
                **financial_metrics,
                "roe": self.ratio_analyzer.calculate_roe(financial_metrics.get("net_income") or 0.0, financial_metrics.get("equity") or 0.0) if financial_metrics.get("net_income") is not None else None,
                "roa": self.ratio_analyzer.calculate_roe(financial_metrics.get("net_income") or 0.0, (financial_metrics.get("equity") or 0.0) + (financial_metrics.get("debt") or 0.0)) if financial_metrics.get("net_income") is not None else None,
                "current_ratio": self.ratio_analyzer.calculate_current_ratio(self._coerce_float(info.get("currentRatio")) or 0.0, 1.0) if info.get("currentRatio") is not None else None,
                "debt_to_equity": self.ratio_analyzer.calculate_debt_to_equity(0.0, financial_metrics.get("debt") or 0.0, financial_metrics.get("equity") or 0.0),
                "gross_margin": None,
